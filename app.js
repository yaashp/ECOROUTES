...
const defaults = [
  {foodIdx: FOOD_DATA.findIndex(f=>f.ingredient==='Rice'), weightKg:0.5, transport:'Road'},
  {foodIdx: FOOD_DATA.findIndex(f=>f.ingredient==='Avocado'), weightKg:0.3, transport:'Air'},
  {foodIdx: FOOD_DATA.findIndex(f=>f.ingredient==='Coffee'), weightKg:0.2, transport:'Sea'}
];
defaults.forEach(d => ingredients.push({id:idCounter++, ...d}));
renderIngredients();
recalcAll();
